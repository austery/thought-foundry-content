...
speaker: baoyu.io
title: 为什么你的"AI 优先"战略可能大错特错？ | 宝玉的分享
date: '2026-04-13'
summary: 文章认为，'AI 优先'战略若忽视软件工程基础将失败。强调'软件工程优先'，需坚实的测试、CI/CD、监控与架构。以 CREAO 为例，展示了如何重构流程，让 AI 成为核心构建者，实现开发速度和质量的飞跃。AI 时代工程师核心价值正从代码产量转向决策质量。
