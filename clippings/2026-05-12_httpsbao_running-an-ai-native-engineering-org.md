...
speaker: baoyu.io
title: AI 时代到底该怎么管一个工程团队 | 宝玉的分享
date: '2026-05-12'
summary: 文章分享了 Anthropic 工程与产品负责人 Fiona Fung 关于 AI 时代如何管理工程团队的观点。AI 使编码成本剧降，瓶颈转移至验证、评审与协作。文章主张砍掉过时流程，拥抱代码作为事实来源，采纳即时规划，并将质量保障左移。强调扁平组织、经理从个人贡献者做起，并使用 AI 辅助开发。最终目标是提升产品质量与可靠性，而非 AI 生成代码的比例。
