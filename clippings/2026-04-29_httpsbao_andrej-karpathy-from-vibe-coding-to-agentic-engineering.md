...
speaker: baoyu.io
title: Karpathy 最新访谈：Vibe Coding 只是开始，真正重要的是 Agentic Engineering | 宝玉的分享
date: '2026-04-29'
summary: 本文总结了 Andrej Karpathy 对 AI 编程范式的见解，从“凭感觉编程”（Vibe Coding）到更重要的“智能体工程”（Agentic Engineering），即 Software 3.0。他阐述了 LLM 作为可编程计算机的本质，AI 能力的“锯齿状”特征，以及人类理解和规格设计的重要性，即使 AI 能编写和部署代码。核心是强调理解不能外包，即使智能变得廉价。
