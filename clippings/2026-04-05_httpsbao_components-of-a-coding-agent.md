---
layout: post.njk
source: https://baoyu.io/translations/2026-04-04/components-of-a-coding-agent
speaker: baoyu.io
title: 编程智能体的核心组件【译】 | 宝玉的分享
date: '2026-04-05'
summary: 本文深入剖析了编程智能体（Coding Agent）及其配套的运行框架（Coding Harness）的核心组件。文章区分了大语言模型、推理模型与智能体，并阐述了 Harness 如何通过代码库上下文、提示词缓存、工具调用、上下文瘦身、会话记忆及任务委派等功能，极大地增强 LLM 在软件开发中的实用性。作者以其开源项目 Mini Coding Agent 和 Claude Code、Codex CLI 为例进行说明。
