---
layout: post.njk
source: https://baoyu.io/blog/2026-06-13/codex-design-model-gap
speaker: baoyu.io
title: 为啥 Codex 还不推出类似 Codex Design 的产品？ | 宝玉的分享
date: '2026-06-13'
summary: 文章探讨了为什么 Codex 尚未推出类似 Claude Design 的可交互原型产品。核心观点是，模型能力（如 GPT-5.5）的瓶颈不在于生成静态界面，而在于需要同时具备优秀的 UI/UX 设计能力和复杂系统架构设计能力，才能一次性交付高精度、状态保持完整的交互式原型。
