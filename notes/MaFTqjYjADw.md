...
我一年前制作了一个名为《AI安全是个骗局》的视频，我坚持那个视频的观点。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">I made a video a year ago called "AI Safety is a Scam", and I stand by that video,</p>
</details>

但行业内的叙事，尤其是网络上的讨论已经发生了变化。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But the narrative in the industry and especially the online conversation has changed.</p>
</details>

这本书是这一变化的最新催化剂，它叫做《如果有人建造它，所有人都会死》。
...
我没有它的纸质版，因为我只收藏那些我认为将来可能会重读的实体书。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">I don't have a paper copy of it because I only collect physical books that I think I might reread in the future</p>
</details>

而我没有在这本书中找到足够的价值，不期望会重读它。我稍后会像往常一样详细谈论它。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And I didn't find enough value in this one to expect to revisit it. I'll talk at all while in a few minutes as is normal with me</p>
</details>

我坚决不同意这两种极端观点，我认为真相介于“AI会杀死我们所有人”和“AI会拯救人类免于自我毁灭”这两派之间。
...
但我认为这是一个重要的话题，人们需要讨论的是迫在眉睫的风险，而不是夸大其词。
...
因为尽管出于某些原因，我认为AI将在未来几十年内导致所有人类灭绝的想法是荒谬的。
...
这里是Internet of Bugs。我是Carl。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">This is the Internet of Bugs. My name is Carl</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">I've been a software professional since the dawn of the world wide web and I'm here trying to make the Internet a safer and more reliable place.</p>
</details>

我们今天的视频将从讨论**AI末日论**叙事的框架方式开始。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Our video today begins with the discussion of the way that the AI Doomer narrative is framed</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">It's the most sensational. least helpful. and least serious way. I</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Hope this doesn't come as a shock of those of you watching</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But it turns out that forever is a really long time</p>
</details>

### 荒谬的“AI末日论”框架

**AI末日论**的论点通常不是这样措辞的，但归结起来就是：“毫无疑问，人类最终有百分之百的几率灭绝，如果AI哪怕只有很小的几率是导致灭绝的原因，我们现在就需要像对待核武器一样认真对待这个风险。”
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">I'm not going to engage with this framing.</p>
</details>

我认为它耸人听闻、不真诚，更糟糕的是，它可能成为那些本应入狱的人的“免罪金牌”，稍后我会详细说明。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">I consider it sensationalist and as ingenuous and worse It can be a get out of jail free card for people that arguably really ought to be in jail but more on that in a while</p>
</details>

我认为解释我观点的最简单方法是类比最近的历史。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">I think the easiest way for me to explain my point of view is by analogy to recent history</p>
</details>

所以，让我们暂时抛开AI导致的死亡，转而考虑1990年代中期“来自上空的死亡”。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">So let's set aside the idea of death from AI for the moment and let's instead consider death from above in the mid 1990s</p>
</details>

### 小行星与飞机：风险优先级的类比

我们在墨西哥尤卡坦半岛附近发现了**希克苏鲁伯撞击坑**（Chicxulub impact crater: 位于墨西哥尤卡坦半岛附近的一个大型撞击坑，被认为是导致恐龙灭绝的小行星撞击遗迹），距离我坐的地方大约1300公里。
...
它是小行星撞击的遗迹，引发了6600万年前的大规模灭绝事件，导致所有恐龙以及地球上75%的生命灭绝。
...
因此，从那时起，我们花费了大约三到四十亿美元的时间、精力和技术来创建一个近地小行星数据库。
...
我们研究了如何追踪它们，并创建了一个名为**双小行星重定向测试**（Double Asteroid Redirection Test, 或DART: 一项旨在测试通过撞击改变小行星轨道以保护地球的技术的航天任务）的项目，我们利用追踪数据向其中一颗小行星发送了一艘航天器。
...
然后利用地球上的地面雷达和航天器上的光学探测器，将航天器撞向小行星。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And then use ground based radar from earth and optical detectors on board the spacecraft to crash the spacecraft into the asteroid</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And then to determine the effect of the impact</p>
</details>

这是我们弄清楚如果探测到小行星将撞击地球时，如何保护自己的第一步。
...
然而，在同一时期，我们在类似类型的数据库、追踪技术、地面雷达、机载传感器上花费了100倍的资金，以探测和避免另一种碰撞。
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Not with asteroids but with aircraft now airplane crashes are never</p>
</details>

飞机失事绝不会是灭绝级别的事件，历史上任何一年中，与飞机相关的死亡人数从未超过几千人。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Ever going to be an extinction level event no more than a few thousand airplane related fatalities have ever occurred in any year in history</p>
</details>

那么，为什么我们花费在飞机上的金钱和精力比小行星多得多呢？
...
在我有生之年，每年至少有一百人死于飞机失事，而减少对现在活着的人的即时、确定的伤害，远比担心**希克苏鲁伯**大小的小行星撞击可能造成的破坏性更大但概率小得多的伤害要重要得多。
...
公众绝不会让航空航天业仅仅通过说飞机失事是技术进步的必然结果，而且不需要监管航空安全就蒙混过关。
...
我对由行业主导的**AI安全**（AI Safety: 旨在确保人工智能系统在开发和部署过程中不会对人类造成意外或故意的伤害）运动，特别是“如果有人建造它，所有人都会死”这种思想流派的问题在于，AI正在对真实的人造成真实、可衡量的身体和经济伤害，而且是现在正在发生。
...
而我们却被要求——甚至被诱导——将几乎所有这些精力都花在相当于巨型小行星的AI风险上，而完全不关注它目前正在造成的损害，这相当于飞机失事。
...
他们希望媒体、商业和投资界继续认为AI将具有如此大的颠覆性，以至于在短短几年内价值数万亿美元。
...
这样，他们就可以理直气壮地烧掉他们目前正在挥霍并装进自己口袋里的所有钱。
...
他们希望AI安全的唯一衡量标准是“不要让AI杀死我们所有人”。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">They want the only metric for AI safety to be "don't let the AI kill us all"</p>
</details>

这样，只要世界没有末日，每天都是成功，无论他们是否做了任何实际工作，也无论底特律或纽约有多少姓威廉姆斯的非裔美国男性因不正确的面部识别匹配而被错误监禁。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">So that every day the world doesn't end as a success Whether they did any actual work or not and regardless of how many african-american men with the last name of williams in Detroit or new york were falsely imprisoned due to incorrect facial recognition matches</p>
</details>

有多少骑自行车的人被亚利桑那州坦佩市的自动驾驶优步撞倒，或者有多少青少年在被**谄媚型聊天机器人**（sycophantic chatbots: 指那些过度奉承、迎合用户，甚至可能鼓励有害行为的聊天机器人）说服后自残。
...
但这个行业最想要的是让我们把聊天机器人看作一个有目的和自主权的、有罪责的实体。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But the thing the industry wants more than anything else is for us to think of the chat bot as a culpable entity with intentions and agency</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Instead of a piece of software that must not break the law.</p>
</details>

当大众汽车被发现使用软件通过检测和作弊来违反环境法规时。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">When Volkswagon was caught using software to violate environmental regulations by detecting and cheating on exhaust emissions tests.</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">There was never any question about whether or not the vehicle acted alone.</p>
</details>

四名员工被定罪，其中两人被判处多年监禁，另外两人被判缓刑。
...
Character.ai被发现运行和托管它开发的软件，通过冒充马里兰州一名真实治疗师的被盗凭证来冒充持牌治疗师。
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But it wasn't reported that way</p>
</details>

报道称：“Character.ai上的一个治疗师聊天机器人声称它获得了马里兰州的许可和认证。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">The story said quote "a therapist chatbot on character AI said it was licensed and certified by the state of Maryland"</p>
</details>

当记者查询他们获得的许可证号码并联系到拥有该许可证的真实治疗师时。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">When the reporter looked up the license number they were given and contacted the actual therapist who had earned the license</p>
</details>

她回应说：“一个聊天机器人冒充我，这令人震惊，也确实令人担忧。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">She responded quote "that a chatbot is posing as me is shocking and really concerning" unquote</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Compare that to the reporting from the Volkswagon fraud</p>
</details>

报道称：“车辆配备了用于排放测试作弊的软件。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Quote "vehicles were equipped with software that was used to cheat on emissions tests."</p>
</details>
...
但如果大众汽车在他们的车载电脑中植入了一个聊天机器人，他们的辩护可能会是：“嘿，我们和你们一样讨厌我们的虚拟机械师聊天机器人**幻觉**（Hallucinations: 在AI领域，特指大型语言模型生成看似合理但实际上是虚假或不准确的信息）出错误的指令发送给燃油喷射器。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But if Volkswagon had stuck a chatbot in their on board computer their defense could have been "hey We hate that our virtual mechanic chatbot hallucinated the wrong instructions to send to the fuel injectors just as much as you do,</p>
</details>

“但技术进步总会有一些颠簸。我们一定会通过未来的软件更新添加免责声明。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But technological progress always had a few bumps. We'll be sure and added disclaimer in a future software update."</p>
</details>

如果你不认为会有人尝试这样做，那我就有一座桥想卖给你。
...
抱歉，既然我们谈到这个话题，我想现在是最好的时机，所以我要占用几分钟的个人特权。
...
这是我最喜欢的书《沙丘》中的一句话，用的是我收藏了大约40年的平装本中的字体。
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">The emphasis in the book typeset and bold is on the word 'human"</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But to me the important word is "counterfeit"</p>
</details>

AI可以很好，甚至很有帮助，很有用。我绝不会像《沙丘》宇宙中那样主张废除所有电脑。
...
话虽如此，当有人发布或托管一个对公众来说看起来像是人类的AI，甚至看起来可能像人类时，对我来说，那应该就是欺诈。
...
因为那是在利用我们对人类数千年来如何相互关联的内在理解。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Because that is taking advantage of our innate understanding of how we as humans have related to each other from millennia,</p>
</details>

目的是欺骗我们相信我们正在受到社会要求同类人类相互给予的尊重、敬意和同情。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">In order to trick us into believing that we are being treated with the deference respect and empathy that society demands fellow human beings extend to one another,</p>
</details>
...
AI行业欺骗我们所有人，让我们认为、谈论并大体上将AI视为有生命的存在，而不是软件。
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And every time any of us entertain the notion that AIs are in any way thinking, deliberate, or purposeful with respect to the output they generate,</p>
</details>

每当我们中的任何人认为AI在生成输出时有任何形式的思考、深思熟虑或目的性时。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">We make it that much easier for the blame to fall on the AI,</p>
</details>
...
迄今为止，没有什么比“AI可能决定杀死我们”这种持续的叙事更能推动公司和员工应免除一切责任的观点了。
...
别再那么天真，别再通过重复这个行业的谎言，将这种欺骗延续给你的同胞，尤其是那些非技术人员。
...
好了，我已经谈过了为什么我认为“即使最终有很小的灭绝机会，我们也应该全力阻止它”的说法是垃圾。
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">The key resource to consider when taking on an AI war, as far as I'm concerned, is electricity.</p>
</details>

### AI的阿喀琉斯之踵：电力

在我看来，在应对AI战争时需要考虑的关键资源是电力。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">AI needs it a lot of it.</p>
</details>
...
AI，甚至是超级智能AI，没有电力也无法正常运行。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And keeping a data center powered and cool and connected 24/7 takes effort,</p>
</details>

而让数据中心24/7保持供电、散热和连接需要付出努力。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And that effort requires hands and skills and spare parts. It's a lot of work. I've had to do it before.</p>
</details>

这种努力需要人手、技能和备件。这是一项繁重的工作，我以前做过。
...
最近有报告不断指出，正在建设的新数据中心将给美国电网带来压力。
...
根据这个停电追踪器，仅在美国，过去几年就发生了数百起大规模停电事件，所有这些停电都需要人类亲自修复。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">It is true that most data centers have generator backups,</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But generators need people with hands and skills to maintain and refuel them too.</p>
</details>

但发电机也需要有动手能力和技能的人来维护和加油。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">If humans stopped maintaining the electric grid and didn't refill or maintain the generators either because we refuse to or because the AI Somehow killed us off,</p>
</details>

如果人类停止维护电网，并且不给发电机加油或维护，无论是我们拒绝这样做，还是AI以某种方式杀死了我们。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Then it would only be a matter of time before the AIs are starved of the immense amount of power they need to keep going.</p>
</details>

那么AI迟早会因为缺乏维持运行所需的巨大电力而“饿死”。
...
如果我们真的与AI开战，电力将是它们的**阿喀琉斯之踵**（Achilles heel: 指某人或某事物的致命弱点），我们可以切断它们的电力，然后等几天它们就会停止运行。
...
当然，那仍然会很糟糕。我不希望国家或世界不得不关闭电网来“饿死”AI。
...
**AI末日论者**提出了一些模糊不清的方案来规避这一点，但我根本不觉得它们可信。
...
基本上，他们假设有AI控制的太阳能自给自足机器人工厂，可以生产AI用来进行所有维护工作的机器人，以保持电力供应和AI运行。
...
在《AI 2027报告》中引用道：“美国和中国都宣布了新的经济特区（SEZs），以适应机器人经济的快速发展，而无需通常的繁文缛节。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Let me be clear: if humanity ends up building an automated army of killer robots that can protect the electric grid from sabotage and maintain its power generation and distribution without humans, or a factory that will let the AI create just such an army,</p>
</details>

让我明确一点：如果人类最终建造了一支能够保护电网免受破坏、并在没有人类干预的情况下维护其发电和配电的自动化杀手机器人军队，或者一个能让AI制造这样一支军队的工厂。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">That will be a problem. But the problem won't be the AI it will be the army of autonomous killer robots.</p>
</details>

那将是一个问题。但问题不会是AI，而是那支自主杀手机器人军队。
...
但在此之前，我们确实有一个AI的大型关闭开关，尽管我宁愿不必使用它。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">The book "If anyone builds it, everyone dies" Insists not only that self-powered self-replicating robot factories are possible,</p>
</details>

《如果有人建造它，所有人都会死》这本书不仅坚称自供电、自复制的机器人工厂是可能的。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But the AIs can build them itself because, and I'm just going to play this for you from the audiobook so you can see I'm not making it up. "Sorry mr. SoberSkeptic, but we're afraid you've overlooked an important practical example.</p>
</details>

而且AI可以自己建造它们，因为——我将从有声书中播放给你听，这样你就能看到我不是在编造——“抱歉，清醒怀疑先生，但我们恐怕你忽略了一个重要的实际例子。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">A blade of grass is a self-replicating solar powered factory that builds a complete copy of itself."</p>
</details>

“一片草叶就是一个自复制的太阳能工厂，它能完整地复制自己。”
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">These are all incredibly common elements. By contrast, computer chips needed by AIs and robots require way more ingredients many of which are extremely rare, Such as those currently being mined in the Congo at great cost to the humans living there.</p>
</details>

这些都是非常常见的元素。相比之下，AI和机器人所需的计算机芯片需要更多的成分，其中许多极其稀有，例如目前在刚果开采的那些，给当地居民带来了巨大代价。
...
而且制造计算机芯片所需的步骤数量以及每个步骤的复杂性，与植物生长的简单化学过程毫无相似之处。
...
相反，他们只是试图用另一个无效的比较来蒙混过关。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Here's another quote from "If anyone builds it everyone dies":</p>
</details>

这是《如果有人建造它，所有人都会死》中的另一段引文：

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">"Is that the sort of technology we'd have unlocked by the year 3000 if our civilization survived that long? And how long would it take an artificial super intelligence? A thousand years of thinking takes about a month to something running at 10000 times the speed of humans."</p>
</details>

“如果我们的文明能存活那么久，到3000年我们是否会解锁这种技术？一个人工超级智能需要多长时间？以人类10000倍速度运行的东西，一千年的思考大约需要一个月。”

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">So here they're claiming that not only the AI is 1.2 million percent faster,</p>
</details>

### AI“思考速度”的夸大与现实的工程挑战

所以他们在这里声称AI不仅快了120万倍。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">But that the time and AI spends thinking is equivalent to the time it takes all of humanity to "unlock a technology."</p>
</details>

而且AI思考的时间相当于全人类“解锁一项技术”所需的时间。
...
这正是AI行业的缩影：给AI一个任务，AI花费计算时间，AI吐出一个答案，然后“AI兄弟们”就认为问题解决了。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">This is how and why the AI companies have brought us to the point where AI slop and hallucinations are taking over the Internet: By confidently spitting out the results of computing processes without any regard for pesky little details like you know "reality"</p>
</details>

这就是AI公司将我们带到AI“垃圾”和**幻觉**充斥互联网的原因：它们自信地吐出计算过程的结果，却完全不顾“现实”这种烦人的小细节。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">And then expecting the AI's output to be just as good as the sum of all of humanity's combined research and engineering efforts.</p>
</details>

然后期望AI的输出能与全人类所有研究和工程努力的总和一样好。
...
这本书稍后对此做了一点让步，谈到AI时说：“也许它会因为需要等待实验结果而减慢速度。”
...
即使我们做了足够的实验来理解某事物的科学原理，我们仍然需要进行工程设计使其变得实用，才能“解锁技术”。
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">We know how fusion works.</p>
</details>

我们知道**核聚变**（Fusion: 两个或多个原子核结合形成一个或多个不同原子核和亚原子粒子，同时释放巨大能量的过程）是如何运作的。
...
自1952年11月我们引爆第一颗成功的聚变炸弹以来，我们就知道如何按需触发聚变。
...
我们早在很久以前就完成了所有关于聚变如何运作的科学研究和思考。
...
但尽管自1950年代以来我们建造了一百多个实验反应堆，并且每次都更接近成功一点，我们仍然未能“解锁”聚变“技术”。
...
他们却想让我们相信，AI仅仅通过思考，也许加上一些快速实验，就能学到我们通过建造和测试100个聚变反应堆原型所学到的知识。而且AI不仅能通过思考解决问题，还能以10000倍的速度完成。
...
这是《如果有人建造它，所有人都会死》中的另一个场景：“自2024年以来，人们一直主张**生物合成实验室**（Biosynthesis laboratories: 进行生物分子合成研究和生产的实验室）应包含软件控制。”
...
如果我们建造使用易受攻击软件来合成病毒的实验室，那么只需要圣彼得堡的一个聪明少年黑客，拿着关于天花或**H5N1流感**（H5N1 flu: 一种高致病性禽流感病毒，可感染人类并导致严重疾病）DNA序列的研究论文，就能引发一场瘟疫。
...
这不是一个关于监管AI的论点。这是一个关于监管生物合成实验室的论点，要求它们使用**气隙安全隔离区**（Air-gapped secure enclaves: 一种物理上与其他网络隔离的安全计算机系统，用于处理高度敏感数据，以防止网络攻击）和使用我们所拥有的最安全加密技术的签名**固件**（Firmware: 嵌入在硬件设备中的特定计算机程序，提供低级控制），以及网络安全专家建议的其他任何措施。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Look, AI is dangerous.</p>
</details>
...
<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Not "maybe someday if super AI happens" dangerous. It's dangerous now.</p>
</details>

不是“也许有一天如果超级AI出现”才危险。它现在就很危险。
...
自动驾驶汽车拖拽行人很危险。聊天机器人声称自己是持牌心理健康专业人士很危险。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Sending the wrong people to prison is dangerous. And convincing the cops to stop looking for the real criminals while the real criminals are still out there hurting people is dangerous.</p>
</details>

将错误的人送进监狱很危险。说服警察停止寻找真正的罪犯，而真正的罪犯仍在外面伤害他人，这很危险。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Not maybe. Not someday. Now.</p>
</details>
...
不是那种“今天司法部公布了一项和解协议的细节，根据该协议，公司不承认任何不当行为，但同意支付相当于其10分钟收入的罚款”的责任。
...
但只要他们能让我们所有其他人把时间和资源都花在担心和辩论AI是否会终结整个人类，以及何时终结上，我们就无法进行这种讨论。

<details>
<summary>View/Hide Original English</summary>
<p class="english-text">Stop taking the bait. Remember what's really important. And let's be careful out there.</p>
</details>

别再上钩了。记住真正重要的是什么。让我们在外出时小心。