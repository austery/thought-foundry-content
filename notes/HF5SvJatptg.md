...
Bloomberg: We'll discuss the valuation anxiety in their latest Bank of America survey.
...
迈克·谢泼德：埃德，最新情况是，在中国和美国双方准备会晤讨论这些问题，并可能在唐纳德·特朗普总统和习近平主席之间举行峰会之前，中国现在正在“踩油门”而不是“踩刹车”。
...
迈克·谢泼德：欧盟现在正在考虑是否要求希望在欧盟内部运营的中国公司分享技术。
...
埃德·莱洛：北京现在阻止安世半导体及其分包商从亚洲国家出口产品，该公司是中国闻泰科技的子公司，也是汽车和消费电子行业使用的成熟芯片的关键供应商。
...
贝利·利普尔斯：如果你睡着了，或者周末休息去看大学橄榄球赛，突然比特币回调了，那么，你猜怎么着？
...
贝利·利普尔斯：所以当你看到过去六个月股票的交易情况，甚至如果你回到四月份的底部，如果你错过了立即的反弹，即使你认为股市被高估了，你也会继续买入。
...
Bailey Lipils: **Quantum stocks** (Quantum Stocks: 量子计算概念股，指与量子计算技术开发、应用相关的公司股票) are up hundreds of percents.
...
埃德·莱洛：接下来，AMD宣布与甲骨文达成新协议，将提供更多AI芯片。我们稍后将详细介绍。
...
Ian King: I mean, they were the best of follow a group that's following Nvidia.
...
Peter Lstrom: It was about $8.5 billion.
...
埃德·莱洛：我们如何报道三星这家拥有众多不同业务部门的公司？目前，三星是亚洲最重要的科技公司吗？
...
彼得·莱斯特罗姆：他们都签订了合同，能够提供这些记忆芯片，因为OpenAI正在美国及其他地区开展这项巨大的数据中心建设工程。
...
彼得·莱斯特罗姆：他们当然生产这些记忆芯片，这才是他们赚钱的真正来源。
...
Caroline Hyde: What is your big strategy?
...
Darren McDonald: So, there isn't anything out there in the market like what we do.
...
Darren McDonald: Yeah, we don't have anything to announce today, but we're certainly looking at alternative opportunities for our hardware.
...
May Habib: Yeah. What we do is help companies rewire operations to be AI native.
...
马蒂·斯坦尼斯基：我们很高兴来到Dreamforce，作为我们工作的一部分，我们将为Agent Force提供语音支持，推动其在整个平台上的工作。
...
埃德·莱洛：你们两位刚刚告诉我们，我们确实看到了企业中的采用情况。
...
Ed Lelo: And what's so interesting really, Matty, has been the ongoing anxiety among that enterprise workforce about whether they're being augmented or whether indeed they're being replaced.
...
May Habib: And I think that just getting harder for smaller startups to enter the enterprise as a result.
...
Ed Lelo: It's a new move following Instagram's launch of teen accounts last fall.
...
塔拉·霍普金斯：他们对我们谈论什么是适合年龄的，或者我们如何进行年龄限制，以及许多家长不真正理解的那种技术术语感到有些困惑。
...
塔拉·霍普金斯：所以我们做的第一件事是审查了我们的政策，所有关于什么是不适合团队的不当内容的指导方针。

Tara Hopkins: So what's what's appropriate for a team?

塔拉·霍普金斯：那么，什么才是适合团队的呢？

Tara Hopkins: So, we did that review on Instagram, and then what we've done is we've built the **classifiers** (Classifiers: 分类器，在机器学习和人工智能中，指一种算法或模型，用于将数据点分配到预定义的类别或组中), our technology, the AI that we use, and we've retrained it on some of these new roles and rules and tweaks and adaptations we've made to the policies that then goes out across the system and then we we find content that we don't believe to be in that PG-13 movie rating kind of space, we will either hide it from teams or we'll remove it entirely.

塔拉·霍普金斯：所以，我们在Instagram上进行了审查，然后我们所做的是构建了 **分类器**（Classifiers: 分类器，在机器学习和人工智能中，指一种算法或模型，用于将数据点分配到预定义的类别或组中），也就是我们的技术，我们使用的人工智能，并根据我们对政策做出的新角色、规则、调整和适应重新训练了它，然后将其推广到整个系统中。如果我们发现不属于PG-13电影分级范围的内容，我们将选择对团队隐藏或完全删除。

Ed Lelo: Tara, there's still questions about from a how the technology and from a policy perspective you define what is or what is not PG-13.

埃德·莱洛：塔拉，关于你们如何从技术和政策角度定义什么是或什么不是PG-13，仍然存在疑问。

Ed Lelo: So, could you answer that more specifically for on a post-by-post basis?

埃德·莱洛：那么，你能否更具体地回答，对于每一篇帖子来说，是如何做出决定的？

Ed Lelo: How is a decision made this is or this is not PG-13?

埃德·莱洛：如何决定这是否是PG-13内容？

Tara Hopkins: Yes. So, the first thing is we don't rate if you're on Instagram and how how this is going to look and feel if you're a teenager on Instagram.

塔拉·霍普金斯：是的。所以，首先，如果你是Instagram上的青少年用户，我们不会对内容进行评级，而是关注它看起来和感觉如何。

Tara Hopkins: Now, first of all, we're going to be sending a notification at the top of your feed for teenagers to let them know what we're doing here, to let them know that we're going to be aligning and guided by PG-13 ratings.

塔拉·霍普金斯：首先，我们将向青少年的信息流顶部发送通知，让他们知道我们正在做什么，让他们知道我们将遵循PG-13评级标准。

Tara Hopkins: What it will look and feel like if you're if you're a parent is hopefully that they will understand, again, we're going to be sending notifications to parents.

塔拉·霍普金斯：如果你是一位家长，它看起来和感觉起来会是怎样的呢？希望他们能理解，我们也会向家长发送通知。

Tara Hopkins: Again, really trying to speak the language of parents.

塔拉·霍普金斯：再次强调，我们真的在努力用家长们能理解的语言沟通。

Tara Hopkins: What we've done is we've made some changes to the policies so that if you're thinking about a PG-13 movie, that's the kind of experience your team's going to have.

塔拉·霍普金斯：我们对政策进行了一些修改，这样如果你想到一部PG-13电影，你的团队就会有那种体验。

Tara Hopkins: So, what a good example of that would be around cursing. So, **profanity** (Profanity: 亵渎言辞，指粗俗、不敬或冒犯性的语言).

塔拉·霍普金斯：所以，一个很好的例子就是关于咒骂。也就是 **亵渎言辞**（Profanity: 亵渎言辞，指粗俗、不敬或冒犯性的语言）。

Tara Hopkins: We've always had rules around profanity on Instagram.

塔拉·霍普金斯：我们一直在Instagram上制定关于亵渎言辞的规定。

Tara Hopkins: And there's certain things you can and can't say.

塔拉·霍普金斯：有些话你可以说，有些话你不能说。

Tara Hopkins: But on a PG-13 movie, they have very, very specific standards around this.

塔拉·霍普金斯：但在PG-13电影中，他们对此有非常非常具体的标准。

Tara Hopkins: You can use one or two quite strong curse words and then other, you know, less less more minor curse words.

塔拉·霍普金斯：你可以使用一两个相当强烈的脏话，然后其他一些，你知道，不那么严重的脏话。

Tara Hopkins: So, what we did is we looked at this.

塔拉·霍普金斯：所以，我们研究了这一点。

Tara Hopkins: We're not apples for apples, of course, you know, we're a social media company as opposed to making movies, but we thought, what would be the equivalent on Instagram?

塔拉·霍普金斯：我们当然不能完全照搬，毕竟我们是社交媒体公司，不是电影制作公司，但我们想，在Instagram上 equivalent 会是什么？

Tara Hopkins: The equivalent on Instagram is we're not going to be recommending content to teens that has severe what we would describe as severe curse words.

塔拉·霍普金斯：在Instagram上的等效做法是，我们不会向青少年推荐含有我们认为“严重咒骂词”的内容。

Tara Hopkins: So, we train the AI to find those types of curse words and we will remove them so that we're not going to be recommending that kind of content to teens.

塔拉·霍普金斯：所以，我们训练AI来识别那些类型的脏话，我们会将其移除，这样我们就不会向青少年推荐这类内容。

Ed Lelo: Tara, what other protections are you thinking about doing additionally going forward?

埃德·莱洛：塔拉，未来你们还在考虑采取哪些额外的保护措施？

Tara Hopkins: So, we're also announcing today two further things.

塔拉·霍普金斯：所以，我们今天还宣布了另外两件事。

Tara Hopkins: One is that we're going to be giving parents more control if they wish to.

塔拉·霍普金斯：一是，如果家长愿意，我们将给予他们更多控制权。

Tara Hopkins: So again, these this update is for all teens under the age of 18.

塔拉·霍普金斯：所以再次强调，这次更新适用于所有18岁以下的青少年。

Tara Hopkins: When we know you're under the age of 18, you're going to be moved by default into the PG-13 or the plus 13 setting on Instagram.

塔拉·霍普金斯：当我们知道你未满18岁时，你将被默认移至Instagram的PG-13或13+设置。

Tara Hopkins: That's the first thing.

塔拉·霍普金斯：这是第一点。

Tara Hopkins: But if a parent wants to go that step further, we're really going to help parents to do that.

塔拉·霍普金斯：但如果家长想更进一步，我们真的会帮助他们做到。

Tara Hopkins: So one of the additional one of the other things we're doing announcing today is that we will have even more limited content control.

塔拉·霍普金斯：所以我们今天宣布的另一项额外措施是，我们将有更严格的内容控制。

Tara Hopkins: Parents can go in and they can have a look at that.

塔拉·霍普金斯：家长可以进入查看。

Tara Hopkins: They can talk to their teen, have a conversation with them.

塔拉·霍普金斯：他们可以和他们的青少年交谈。

Tara Hopkins: Particularly if your teenager is in that younger category, you might want to limit the content even further.

塔拉·霍普金斯：特别是如果你的青少年属于较年轻的年龄段，你可能希望进一步限制内容。

Ed Lelo: Briefly, you got tens of millions of teen accounts.

埃德·莱洛：简单来说，你们有数千万的青少年账户。

Ed Lelo: How many are trying to opt out, navigate those **age rules** (Age Rules: 年龄规则，指平台或服务为不同年龄段用户设定的内容访问、功能使用等规定)?

埃德·莱洛：有多少人试图退出，绕过那些 **年龄规则**（Age Rules: 年龄规则，指平台或服务为不同年龄段用户设定的内容访问、功能使用等规定）？

Ed Lelo: How are you ensuring that they do remain within those **age catchments** (Age Catchments: 年龄范围，指特定年龄段的用户群体)?

埃德·莱洛：你们如何确保他们确实留在那些 **年龄范围**（Age Catchments: 年龄范围，指特定年龄段的用户群体）内？

Tara Hopkins: So, we now have hundreds of millions of teens in the teen account experience, which which has been which we launched last year, which is really good news.

塔拉·霍普金斯：所以，我们现在有数亿青少年在使用我们去年推出的青少年账户体验，这真的是个好消息。

Tara Hopkins: We've been able to do that technically, which is a pretty big challenge to be able to do that.

塔拉·霍普金斯：我们已经能够在技术上做到这一点，这本身就是一个相当大的挑战。

Tara Hopkins: We know that 97% of teens that we've moved into the teen account experience have not tried to change those more protective settings when they're in the younger age category.

塔拉·霍普金斯：我们知道，在我们将其转入青少年账户体验的青少年中，有97%在较年轻的年龄段时没有尝试更改那些更具保护性的设置。

Tara Hopkins: So teens below the age of 16 cannot change the settings we set in teen accounts without getting a parent's permission.

塔拉·霍普金斯：因此，16岁以下的青少年未经父母许可不能更改我们在青少年账户中设置的选项。

Tara Hopkins: We're going a step further with these content setting changes which is it's for every teen under the age of 18, but they can't change them unless they get a parent to approve it as well.

塔拉·霍普金斯：我们正在进一步推进这些内容设置的更改，这些更改适用于所有18岁以下的青少年，但他们除非得到父母的批准，否则无法更改这些设置。

Ed Lelo: Tara Hopkins, global director for policy for Instagram.

埃德·莱洛：塔拉·霍普金斯，Instagram全球政策总监。

Ed Lelo: Thank you very much for joining us here on Bloomberg Tech.

埃德·莱洛：非常感谢您加入我们的彭博科技节目。

### 全球科技速览：SpaceX、苹果、谷歌与欧洲AI雄心

Ed Lelo: Okay, coming up, Europe races to prove Jensen One wrong about their AI capabilities.

埃德·莱洛：好的，接下来，欧洲正努力证明黄仁勋对其AI能力的看法是错误的。

Ed Lelo: That Bloomberg deep dive next. This is Bloomberg Tech.

埃德·莱洛：彭博社的深度报道将在稍后播出。这里是彭博科技。

Ed Lelo: Time now for talking tech and first up, SpaceX.

埃德·莱洛：现在是科技话题时间，首先是SpaceX。

Ed Lelo: Well, it's pulled off another successful launch and return of its **Starship rocket** (Starship Rocket: 星舰火箭，由SpaceX公司开发的一种完全可重复使用的超重型运载火箭，旨在进行深空探索和载人火星任务), which deployed **test satellite** (Test Satellite: 测试卫星，用于验证新技术、新设计或新功能的实验性卫星) into orbit.

埃德·莱洛：SpaceX再次成功发射并回收了其 **星舰火箭**（Starship Rocket: 星舰火箭，由SpaceX公司开发的一种完全可重复使用的超重型运载火箭，旨在进行深空探索和载人火星任务），该火箭将 **测试卫星**（Test Satellite: 测试卫星，用于验证新技术、新设计或新功能的实验性卫星）部署到轨道。

Ed Lelo: Elon Musk's space company still has to demonstrate and master several novel technologies to meet Inc's goal of a **lunar landing** (Lunar Landing: 月球着陆，指航天器在月球表面成功着陆) in the next two years.

埃德·莱洛：埃隆·马斯克的这家太空公司仍需展示并掌握多项新颖技术，才能实现未来两年内 **月球着陆**（Lunar Landing: 月球着陆，指航天器在月球表面成功着陆）的目标。

Ed Lelo: Plus, Apple, well, it set a release date for the launch of its super thin iPhone Air in China.

埃德·莱洛：此外，苹果公司为其超薄款iPhone Air在中国上市设定了发布日期。

Ed Lelo: The phone will be available in stores later this month after a pause that allow local carriers to prepare for the device, which is **eim** (eSIM: 嵌入式SIM卡，一种直接嵌入设备中的数字SIM卡，无需物理插拔即可切换运营商) only.

埃德·莱洛：这款手机将于本月晚些时候在商店上市，此前曾暂停一段时间，以便当地运营商为这款仅支持 **eSIM**（eSIM: 嵌入式SIM卡，一种直接嵌入设备中的数字SIM卡，无需物理插拔即可切换运营商）的设备做准备。

Ed Lelo: The news coincided with a visit to the country by Apple CEO Tim Cook.

埃德·莱洛：这一消息恰逢苹果首席执行官蒂姆·库克访问中国。

Ed Lelo: And Google is planning its biggest investment in India yet, about $15 billion to build an **AI infrastructure hub** (AI Infrastructure Hub: AI基础设施中心，指集成了大量计算资源、数据存储和网络连接，专门用于支持人工智能开发和部署的设施) in the south over the next five years.

埃德·莱洛：谷歌正计划在印度进行迄今为止最大的一笔投资，未来五年内将在印度南部投入约150亿美元，建设一个 **AI基础设施中心**（AI Infrastructure Hub: AI基础设施中心，指集成了大量计算资源、数据存储和网络连接，专门用于支持人工智能开发和部署的设施）。

Ed Lelo: India has been one of the biggest winners of the global AI boom, and the project will help accelerate local government efforts to expand the AI industry.

埃德·莱洛：印度一直是全球AI热潮的最大赢家之一，该项目将有助于加速地方政府扩大AI产业的努力。

Ed Lelo: Nvidia's Jensen Wong issued an AI warning to Europe and France over the summer.

埃德·莱洛：英伟达的黄仁勋在夏天向欧洲和法国发出了AI警告。

Ed Lelo: You are too slow.

埃德·莱洛：你们太慢了。

Ed Lelo: Now, European leaders are working to prove him wrong with many committing billions to homegrown AI startups and services.

埃德·莱洛：现在，欧洲领导人正努力证明他错了，许多国家承诺向本土AI初创企业和服务投入数十亿美元。

Ed Lelo: Bloomberg's European tech reporter Mark Bergen has been writing about Europe's attempts at catching up and joins us now.

埃德·莱洛：彭博社欧洲科技记者马克·伯根一直在报道欧洲追赶的尝试，他现在加入了我们。

Ed Lelo: Jensen Wong says, "You are too slow at sort of an EU-wide level or country-by-country level.

埃德·莱洛：黄仁勋说：“你们在欧盟层面或国家层面都太慢了。”

Ed Lelo: What is it that they're actually doing to prove him wrong or at least catch up?"

埃德·莱洛：他们究竟在做些什么来证明他错了，或者至少赶上来？

Mark Bergen: Yeah, that anecdote from our story was like the lead of it was a dinner hosted by Emanuel Mcronone and in a way before his government collapsed.

马克·伯根：是的，我们故事中的那个轶事，就像开头一样，是埃马纽埃尔·马克龙（Emmanuel Macron）在他政府垮台前举办的一次晚宴。

Mark Bergen: They France was seen as the vanguard here.

马克·伯根：法国在这里被视为先锋。

Mark Bergen: They had that this early this year they announced the largest data center project in the EU.

马克·伯根：他们今年早些时候宣布了欧盟最大的数据中心项目。

Mark Bergen: They have Mestral, which is the closest thing that Europe has to sort of an OpenAI rival.

马克·伯根：他们有Mestral，这是欧洲最接近OpenAI竞争对手的产品。

Mark Bergen: And a lot of money and public support from the government.

马克·伯根：以及政府的大量资金和公共支持。

Mark Bergen: The European Commission and European Union has put money behind chips, behind what they call these **AI gigafactories** (AI Gigafactories: AI超级工厂，指大规模、高度自动化的数据中心和计算设施，专门用于支持AI模型的训练和部署).

马克·伯根：欧盟委员会和欧盟已经投入资金支持芯片，支持他们所谓的 **AI超级工厂**（AI Gigafactories: AI超级工厂，指大规模、高度自动化的数据中心和计算设施，专门用于支持AI模型的训练和部署），基本上就是大型数据中心项目。

Mark Bergen: Basically large data center projects.

马克·伯根：基本上就是大型数据中心项目。

Mark Bergen: If you compare the funding though to the US and China, though obviously Europe is still a lagging third place.

马克·伯根：然而，如果你将资金与美国和中国进行比较，显然欧洲仍然是落后的第三名。

Ed Lelo: When we think about the key players of Europe, they do have some standouts.

埃德·莱洛：当我们想到欧洲的主要参与者时，他们确实有一些杰出者。

Ed Lelo: ASML when you think chip equipment making, you've got SAP bringing it to the enterprise.

埃德·莱洛：当你想到芯片设备制造时，有ASML；当你想到企业软件时，有SAP。

Ed Lelo: But where else are they trying to grow their own talent and indeed risk pushing back though the US influx of money that seemed to come with Jensen's last visit?

埃德·莱洛：但是，他们还在哪些方面努力培养自己的本土人才，并且确实冒着风险去抵制似乎随黄仁勋上次访问而来的美国资金涌入呢？

Mark Bergen: Yeah, I think there's a couple things happening and we cried to capture this in the debate.

马克·伯根：是的，我认为有几件事情正在发生，我们试图在辩论中抓住这一点。

Mark Bergen: There are, you know, Jensen has been kind of teased Europe for moving too slowly.

马克·伯根：你知道，黄仁勋一直在嘲讽欧洲行动太慢。

Mark Bergen: Clearly, he wants them to be buying more Nvidia chips.

马克·伯根：显然，他希望他们购买更多的英伟达芯片。

Mark Bergen: And there are others that are argue that maybe this this this sovereignty, this idea of independence from the US and China means not relying on Nvidia, not relying on OpenAI, not relying on Microsoft and the cloud providers.

马克·伯根：也有人认为，这种主权，这种独立于美国和中国的想法，意味着不依赖英伟达，不依赖OpenAI，不依赖微软和云提供商。

Mark Bergen: That's a lot more difficult.

马克·伯根：这要困难得多。

Mark Bergen: I think the cloud is where we're starting to see some really interesting of **Neoclouds** (Neoclouds: 新兴云服务提供商，指提供云计算服务，但规模通常小于超大规模云提供商，且可能专注于特定市场或技术的新兴公司).

马克·伯根：我认为在云领域，我们开始看到一些非常有趣的 **新兴云服务提供商**（Neoclouds: 新兴云服务提供商，指提供云计算服务，但规模通常小于超大规模云提供商，且可能专注于特定市场或技术的新兴公司）。

Mark Bergen: **Nebus** (Nebius: 曾是Yandex云的一部分，后分拆出来专注于在欧洲提供云服务) is a Dutch company here that spun out from Russia's **Yandex** (Yandex: 俄罗斯最大的互联网公司，提供搜索引擎、在线广告、云计算等服务) that's had a really fascinating growth trajectory.

马克·伯根： **Nebius**（Nebius: 曾是Yandex云的一部分，后分拆出来专注于在欧洲提供云服务）是一家荷兰公司，从俄罗斯的 **Yandex**（Yandex: 俄罗斯最大的互联网公司，提供搜索引擎、在线广告、云计算等服务）分拆出来，其增长轨迹非常引人注目。

Mark Bergen: We've seen a lot of these Neocloud companies come up in Europe.

马克·伯根：我们看到许多这样的新兴云公司在欧洲崛起。

Mark Bergen: Some of them are really positioning themselves as alternatives to the US providers.

马克·伯根：其中一些确实将自己定位为美国供应商的替代品。

Ed Lelo: **Endscale** (Endscale: 一家专注于AI基础设施和云原生技术的欧洲公司) being another key name we keep hearing about.

埃德·莱洛： **Endscale**（Endscale: 一家专注于AI基础设施和云原生技术的欧洲公司）是我们不断听到的另一个关键名字。

Ed Lelo: Mark Bergen. Great story.

埃德·莱洛：马克·伯根。很棒的报道。

Ed Lelo: And what you don't want to forget is we're going to dive into all of these topics, so much more next week during **Bloomberg Tech Summit** (Bloomberg Technology Summit: 彭博科技峰会，彭博社举办的科技行业年度盛会，汇集行业领袖、创新者和投资者).

埃德·莱洛：你不想忘记的是，下周在 **彭博科技峰会**（Bloomberg Technology Summit: 彭博科技峰会，彭博社举办的科技行业年度盛会，汇集行业领袖、创新者和投资者）期间，我们将深入探讨所有这些话题，以及更多内容。

Ed Lelo: It's being hosted in London. It's on October the 21st.

埃德·莱洛：它将在伦敦举行。日期是10月21日。

Ed Lelo: But meanwhile, that does it for this edition of Bloomberg Tech.

埃德·莱洛：但与此同时，本期彭博科技节目到此结束。

Ed Lelo: Ed, a lot to digest in terms of **geopolitics** (Geopolitics: 地缘政治，指地理因素，特别是国家之间的地理位置和资源分配，对国际政治和国家间关系的影响) and in terms of valuations.

埃德·莱洛：埃德，从 **地缘政治**（Geopolitics: 地缘政治，指地理因素，特别是国家之间的地理位置和资源分配，对国际政治和国家间关系的影响）和估值来看，有很多值得深思的内容。

Caroline Hyde: Yeah, there's still a little bit of anxiety in technology markets.

卡罗琳·海德：是的，科技市场仍然存在一些焦虑。

Caroline Hyde: It's largely focused to trade.

卡罗琳·海德：主要集中在贸易方面。

Caroline Hyde: Salesforce is down 2% on the day that Dreamforce kicks off.

卡罗琳·海德：在Dreamforce大会开幕当天，Salesforce股价下跌了2%。

Caroline Hyde: How's that going to go down?

卡罗琳·海德：这会如何收场？

Caroline Hyde: You can recap that on the podcast.

卡罗琳·海德：你可以在播客上回顾一下。

Caroline Hyde: You know where to find it.

卡罗琳·海德：你知道在哪里可以找到它。

Caroline Hyde: It's online on all those platforms.

卡罗琳·海德：它在所有这些平台上都有在线版本。

Caroline Hyde: It's on the Bloomberg platforms.

卡罗琳·海德：它在彭博平台。

Caroline Hyde: Big week ahead.
