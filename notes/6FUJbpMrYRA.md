...
tags:
  ...
  - agentic-workflow
title: 硅谷AI浪潮的转向：从Token Maxing到Token Efficient的Agent工作范式变革
summary: 文章探讨了AI浪潮从关注模型能力转向关注Agent工程问题的转变。核心议题是探讨最大化Token消耗（Token Maxing）到经济高效使用Token（Token Efficient）的策略，以及Agent工作范式变革的深层含义，包括模型评估、开源与闭源模型的协同、本地化部署的潜力，以及对未来AGI到来时间点的哲学思考。
insight: ''
draft: true
series: ''
